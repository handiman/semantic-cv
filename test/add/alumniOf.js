...
export default () => {
  ...
  describe("alumniOf", () => {
    ...
    describe("inner", () => {
      test("@type", () =>
        assert.strictEqual(person.alumniOf[0].alumniOf["@type"], "EducationalOrganization"));
      test("name", () => assert.strictEqual(person.alumniOf[0].alumniOf.name, values.name));
      test("location", () =>
        assert.strictEqual(person.alumniOf[0].alumniOf.location, values.location));
    });
